...
BREVO_API_KEY = os.environ.get('BREVO_API_KEY') # Your Brevo API Key from .env
BREVO_SENDER_EMAIL = os.environ.get('BREVO_SENDER_EMAIL') # Your verified sender email from .env
